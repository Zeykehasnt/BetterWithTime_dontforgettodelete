...
public class WindmillModel implements UnbakedModel, BakedModel, FabricBakedModel {
    private static final SpriteIdentifier[] SPRITE_IDS = new SpriteIdentifier[]{
            new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, new Identifier("bwt:block/windmill")),
    };
    ...
    private static final int WINDMILL_SPRITE = 0;
    ...
    @Override
    public BakedModel bake(Baker modLoader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        // Get the sprites
        ...
        for(Direction direction : Direction.values()) {
            ...
            emitter.spriteBake(sprites[WINDMILL_SPRITE], MutableQuadView.BAKE_LOCK_UV);
    ...
    public Sprite getParticleSprite() {
        return sprites[WINDMILL_SPRITE]; // Block break particle, let's use furnace_top
    }
